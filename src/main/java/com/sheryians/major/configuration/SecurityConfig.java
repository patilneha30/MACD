...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http)throws Exception{
        http
                ...
                .csrf()
                .disable();
                http.headers().frameOptions().disable(); // this line should be removed while using some other database
    }
    ...
    private class CustomClientRegistrationRepository implements ClientRegistrationRepository {
        ...
        public ClientRegistration findByRegistrationId(String registrationId) {
            // Implement this method to return ClientRegistration based on registrationId
            return null;
        }
    }
    @Override
